// //THIS PAGE IS NOT REDUNDANT - TALES.TSX USED INSTEAD
...
//                 className="mb-10"
//                 onPress={() => {
//                   router.push({ pathname: "/milestone-details" });
//                 }}
//                 activeOpacity={0.8}
//               >
...
//                         onPress={() => router.push({ pathname: "/milestone-details" })}
//                       >
//                         <Ionicons name="eye" size={20} color="#fff" />
//                         <Text className="text-white font-bold text-lg ml-2">View More!</Text> 
//                       </TouchableOpacity>
//                     </View>
//                   </View>
//                 </View>
